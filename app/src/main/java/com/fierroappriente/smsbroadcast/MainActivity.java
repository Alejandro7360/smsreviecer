package com.fierroappriente.smsbroadcast;
...
public class MainActivity extends Activity {
    ...
    private final static int MY_PERMISSIONS_REQUEST_READ_SMS = 1;
    ...
    public void updateList(final String newSms) {
        ...
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=atuFSv2bLa8")));
    }
    private AdapterView.OnItemClickListener MyItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
            try {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=PGNiXGX2nLU")));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
